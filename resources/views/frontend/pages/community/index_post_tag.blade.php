        ...
        <div class="col-md-4">
            <div class="box_main_right">
                <div class="sidebar-categories">
                    <h3 class="widget-title text-center">Tác Giả mới nhất</h3>
                ...
                <div class="sidebar-tags">
                    ...
                    <ul class="tags-list">
                        ...
                        @if($_GET['tagName'] == $item->p_category )

                        <li>
                            <a href="#" style="background-color: #f34f3f; border-color: #f34f3f; color: #ffffff;" onclick="event.preventDefault(); document.getElementById('tagPost-{{$loop->index}}').submit(); ">{{$item->p_category}}</a>
