    ...
    <div class="container">
        <div class="row flex-row-reverse">
            <div class="col-lg-9">
                ...
                <div class="shop-banner box_main_banner">
                    ...
                    <div class="box_item_banner">
                        ...
                        <div class="box_image_banner">
                            <img src="{{asset($dataSlide->image)}}" alt="">
                        </div>
                ...
                <h1 class="font-weight-bold text-uppercase mt-3 mb-3 text-center">{{$nameCategory->category_name}}</h1>

                <!--Shop Top Bar Start-->
                <div class="shop-top-bar d-sm-flex align-items-center justify-content-between" style="margin: 0;">
                    ...
                    <div class="tab-pane fade" id="list" role="tabpanel">
                        ...
                        <div class="single-product product-list">
                            <div class="product-image">
                                ...
                                <div class="action-links">
                                    <ul>
                                        <li><a href="{{ route('infor.getInfPet',$dataPet->product_id) }}" data-tooltip="tooltip" data-placement="left" data-id="{{$dataPet->product_id}}" title="Quick View" class="icon_show_inf_pet"><i class="icon-eye"></i></a></li>
