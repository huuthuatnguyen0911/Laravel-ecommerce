...
<body>
    ...
    <div class="main_box_page_posts">
        ...
        <section id="content_main" class=" mt-5 mb-5">
            <div class="container-fluid">
                <form action="{{route('personal.post.edit.form',$dataPost->id)}}" id="formCreatePost" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Tiêu đề" id="inpuTitlePost" name="inpuTitle" value="{{$dataPost->p_title}}">
                        <span id="errorInputTitlePost" class=""></span>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Thể loại" id="inpuCategoryPost" name="inpuCategory" value="{{$dataPost->p_category}}">
