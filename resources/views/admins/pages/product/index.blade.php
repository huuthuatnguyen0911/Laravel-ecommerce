    ...
    $(document).ready(function() {
        ...
        $("body").on("click", ".btn_edit_product", function(e) {
            ...
            $.ajax({
                ...
                data: $(this).data("id"),
                success: function(data) {
                    $("#inputIDProduct").val(data.product_id);
                    ...
                    $("#inputNameProduct").val(data.product_name);
                    $("#inputDescription").val(data.product_description);
                    // $('#inputSubDescription').data("wysihtml5").editor.setValue(data.product_sub_description);
                    // // $("#inputSubDescription").val(data.product_sub_description);
                    tinymce.activeEditor.execCommand('mceInsertContent', false, data.product_sub_description);
                }
            })
        })
