...
<div class="container-fluid box_main_prostatus_avtive_nav_product">
    <div class="page-head mt-5">
        <div class="row container_full" style="justify-content: space-between; align-items: center;">
            <div class="col-md-6">
                <h4 class="mt-2 mb-2">Quản lí nhân viên</h4>
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <div class="">
                            <table class="table table-striped" id="tableStaffInfor">
                                <thead>
                                    <tr>
                                        <!-- <th>NO</th> -->
                                        <th>Ảnh</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table1 = $('#tableStaffInfor').DataTable({
                processing: true,
                serverSide: true,
                "order": [[ 4, "desc" ]],
                ajax: "{{ route('user.staff.index') }}",
                columns: [
                    {
                        data: 'avatar',
                        name: 'avatar'
